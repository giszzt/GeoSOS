...
namespace FrameWork
{
    ...
    public class StartUp
    {
        ...
        static void HandleMainException(Exception ex)
        {
            ...
            try
            {
                Application.Run(new ExceptionBox(ex, "Unhandled exception terminated", true));
            }
            catch
            {
        ...
        static bool CheckEnvironment()
        {
            ...
            {
                MessageBox.Show("This version requires .NET 4.0. You are using: " + Environment.Version);
                return false;
            }
