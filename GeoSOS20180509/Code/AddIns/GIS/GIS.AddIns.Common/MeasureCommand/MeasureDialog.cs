...
namespace GIS.AddIns.Common
{
    ...
    public class MeasureDialog : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tsbDistance.Image = global::GIS.AddIns.Common.Properties.Resources.Line;
            ...
            this.tsbArea.Image = global::GIS.AddIns.Common.Properties.Resources.Area;
            ...
            this.label1.Text = StringParser.Parse("${res:GIS.AddIns.Common.MeasureDialog.Total}");
            //
            // lblMeasure
            //
            resources.ApplyResources(this.lblMeasure, "lblMeasure");
            this.lblMeasure.Name = "lblMeasure";
            this.lblMeasure.Text = StringParser.Parse("${res:GIS.AddIns.Common.MeasureDialog.lblMeasure}");
            //
            // label2
            //
            resources.ApplyResources(this.label2, "label2");
            this.label2.Name = "label2";
            this.label2.Text = StringParser.Parse("${res:GIS.AddIns.Common.MeasureDialog.Current}");
            //
            // label3
            //
            resources.ApplyResources(this.label3, "label3");
            this.label3.Name = "label3";
            this.label3.Text = StringParser.Parse("${res:GIS.AddIns.Common.MeasureDialog.units}");
            //
            // lblTotalUnits
            //
            ...
            this.lblTotalUnits.Text = StringParser.Parse("${res:GIS.AddIns.Common.MeasureDialog.Meters}");
            //
            // label4
            //
            resources.ApplyResources(this.label4, "label4");
            this.label4.Name = "label4";
            this.label4.Text = StringParser.Parse("${res:GIS.AddIns.Common.MeasureDialog.Tips}");
            //
            // MeasureDialog
            //
