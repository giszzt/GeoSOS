...
namespace GIS.Common.Dialogs
{
    ...
    public partial class TableEditorControl : UserControl
    {
        ...
        {
            lblSelectedNumber.Text = (numRows + StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_DisplaySelectedRowNumberLable__of_}")
                + (dataGridView1.RowCount - 1) + StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_DisplaySelectedRowNumberLable__Selected}"));
        }
        ...
        public void DisplayFilePathLabel(string file)
        {
            lblFilePath.Text = File.Exists(file)
                ...
                : StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_FileNameInMemory}");
        }
        ...
        private void removeFieldToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (_featureLayer.DataSet.AttributesPopulated)
            {
                ...
                {
                    if (MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_RemoveFields}"),
                        StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_Confirm}"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        ...
        {
            InputBox inbox = new InputBox(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_EnterFindString}"), 
                StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_Find}"));
            if (inbox.ShowDialog() != DialogResult.OK) return;

            string exp = inbox.Result;
            if (exp == null) return;
            if (FindString(exp) == false)
                MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_NoMatch}"));
        }
        ...
        private void exportSelectedFeaturesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            SaveFileDialog sdlg = new SaveFileDialog
                                      {
                                          Filter =
                                              StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_exportSelectedFeaturesToolStripMenuItem_Click_Shapefiles____shp_____SHP}")    
                                      };
        ...
        private void replaceToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (var frmSeachAndReplaceDialog = new SearchAndReplaceDialog())
            {
                ...
                {
                    MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_CouldNotFindReplace}"));
                }
            }
        }
        ...
        private void SaveEdits()
        {
            ...
            {
                MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_SaveEdits_Unable_to_save_edits__}") +
                                ex.Message);
            }
            finally
            {
        ...
        private void ImportFieldsFromDbf()
        {
            OpenFileDialog dlg = new OpenFileDialog
                                     {
                                         Filter =
                                             StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_ImportFieldsFromDbf_DBase_Files____dbf____DBF}")
                                     };
            FeatureSet fsTemp = new FeatureSet();
            fsTemp.CopyFeatures(_featureLayer.DataSet, true);
            if (dlg.ShowDialog() != DialogResult.OK)
            {
                MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_ImportFieldsFromDbf_Could_not_import_column_fields}"));
                return;
            }
        ...
        private void QueryDialog_ChangesApplied(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_CouldNotExecuteQuery}"));
            }
        }
            ...
            for (int r = 0; r < numRow; r++)
            {
                ...
                for (int c = 0; c < numCol; c++)
                {
                    ...
                    if (itemReplaced)
                    {
                        ...
                        {
                            MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_ReplaceString_Unfamilar_data_type_to_replace}"));
                            return false;
                        }
                    }
                }
        ...
        private void CopyFid(string field, bool isNewField)
        {
            ...
            if (field == null)
            {
                MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_CopyFid_Could_not_copy_FID}"));
                return;
            }
            int colIndex = -1;
            if (isNewField)
            ...
            else
            {
                ...
                if (colIndex == -1)
                {
                    MessageBox.Show(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_CopyFid_Couldnt_find_field}"));
                    return;
                }
            }
        ...
        {
            lblSelectedNumber.Text = String.Format(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.TableEditorControl_SelectedRowCountStringFormat}"), dataGridView1.SelectedRows.Count, _featureLayer.DataSet.NumRows());
