...
namespace GIS.Common.Dialogs
{
    ...
    partial class AddNewColum
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblName.Text = StringParser.Parse("${res:GIS.Common.Dialogs.AddNewColum.Name}");
            // 
            // lblType
            // 
            resources.ApplyResources(this.lblType, "lblType");
            this.lblType.Name = "lblType";
            this.lblType.Text = StringParser.Parse("${res:GIS.Common.Dialogs.AddNewColum.Type}");
            // 
            // lblSize
            // 
            resources.ApplyResources(this.lblSize, "lblSize");
            this.lblSize.Name = "lblSize";
            this.lblSize.Text = StringParser.Parse("${res:GIS.Common.Dialogs.AddNewColum.Size}");
            // 
            // txtName
            // 
            ...
            this.dialogButtons1.OkClicked += new System.EventHandler(this.btnOk_Click);
            // 
            // AddNewColum
            // 
