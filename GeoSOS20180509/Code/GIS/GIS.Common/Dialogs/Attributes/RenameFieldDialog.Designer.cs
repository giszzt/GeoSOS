...
namespace GIS.Common.Dialogs
{
    ...
    partial class RenameFieldDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblField.Text = StringParser.Parse("${res:GIS.Common.Dialogs.RenameFieldDialog.Field}");
            //
            // cmbField
            //
            ...
            this.lblName.Text = StringParser.Parse("${res:GIS.Common.Dialogs.RenameFieldDialog.Name}");
            //
            // txtName
            //
            ...
            this.btnCancel.Text = StringParser.Parse("${res:GIS.Common.Dialogs.RenameFieldDialog.Cancel}");
            //
            // btnOK
            //
            ...
            this.btnOK.Text = StringParser.Parse("${res:GIS.Common.Dialogs.RenameFieldDialog.ok}");
            //
            // ReNameField
            //
