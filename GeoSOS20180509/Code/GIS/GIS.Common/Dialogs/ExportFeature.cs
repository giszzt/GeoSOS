...
namespace GIS.Common.Dialogs
{
    ...
    public class ExportFeature : Form
    {
        ...
        {
            InitializeComponent();
            cmbFeatureSpecification.Items.Add(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.ExportFeature_FeaturesAll}"));
            cmbFeatureSpecification.Items.Add(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.ExportFeature_FeaturesSelected}"));
            cmbFeatureSpecification.Items.Add(StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.ExportFeature_FeaturesExtent}"));
