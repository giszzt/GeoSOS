...
namespace GIS.Common.Dialogs
{
    ...
    public class DoubleBox : UserControl
    {
        ...
        public DoubleBox()
        {
            ...
            try
            {
                _invalidHelp = ResourceService.GetString("GIS.Common.Dialogs.SymbologyFormsMessageStrings.DoubleBox_DoubleError");
                _regularHelp = ResourceService.GetString("GIS.Common.Dialogs.SymbologyFormsMessageStrings.DoubleBox_DoubleHelp");
            }
            catch
            {
                _invalidHelp = StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.DoubleBox_DoubleError}");
                _regularHelp = StringParser.Parse("${res:GIS.Common.Dialogs.SymbologyFormsMessageStrings.DoubleBox_DoubleHelp}");
            }
