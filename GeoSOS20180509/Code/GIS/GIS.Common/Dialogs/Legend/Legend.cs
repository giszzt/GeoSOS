...
namespace GIS.Common.Dialogs
{
    ...
    public class Legend : ScrollingControl, ILegend
    {
        ...
        //private LegendContextMenu _legendContextMenu;
        ...
        public Legend()
        {
            ...
            _icoChecked = ResourceService.GetImageResource("Checked") as Icon;
            _icoUnchecked = ResourceService.GetImageResource("UnChecked") as Icon;
        ...
        public List<LegendBox> GetLegendBoxes()
        {
            return _legendBoxes;
        }
        ...
        /// </summary>
        public ContextMenu LegendContextMenu
        {
            get { return _contextMenu; }
            set { _contextMenu = value; }
        }
        /// <summary>
        /// right click and get the selected item
        /// </summary>
        public ILegendItem SelectedLegendMenuItem
        {
        ...
        protected override void OnMouseDoubleClick(MouseEventArgs e)
        {
            ...
            foreach (LegendBox lb in _legendBoxes)
            {
                ...
                if (lc != null)
                {
                    GIS.Common.Dialogs.DetailedLineSymbolDialog lsDialog = new GIS.Common.Dialogs.DetailedLineSymbolDialog(lc.Symbolizer);
                    lsDialog.ShowDialog();
                ...
                if (pc != null)
                {
                    GIS.Common.Dialogs.DetailedPointSymbolDialog dlg = new GIS.Common.Dialogs.DetailedPointSymbolDialog(pc.Symbolizer);
                    dlg.ShowDialog();
                ...
                if (polyCat != null)
                {
                    GIS.Common.Dialogs.DetailedPolygonSymbolDialog dlg = new GIS.Common.Dialogs.DetailedPolygonSymbolDialog(polyCat.Symbolizer);
                    dlg.ShowDialog();
                ...
                if (fl != null)
                {
                    GIS.Common.Dialogs.LayerDialog layDialog = new GIS.Common.Dialogs.LayerDialog(fl, new FeatureCategoryControl());
                    layDialog.ShowDialog();
                }
                IRasterLayer rl = lb.Item as IRasterLayer;
                if (rl != null)
                {
                    GIS.Common.Dialogs.LayerDialog dlg = new GIS.Common.Dialogs.LayerDialog(rl, new RasterCategoryControl());
                    dlg.ShowDialog();
                }
