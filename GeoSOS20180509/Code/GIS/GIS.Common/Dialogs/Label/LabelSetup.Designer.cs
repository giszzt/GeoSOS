...
namespace GIS.Common.Dialogs
{
    public partial class LabelSetup
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sqlExpression = new ExpressionControl();
            ...
            this.sldBorderOpacity = new RampSlider();
            this.cbBorderColor = new ColorButton();
            this.gpbFont = new System.Windows.Forms.GroupBox();
            this.lblFontColor = new System.Windows.Forms.Label();
            this.sldFontOpacity = new RampSlider();
            this.cbFontColor = new ColorButton();
            this.cmbStyle = new System.Windows.Forms.ComboBox();
            this.lblFamily = new System.Windows.Forms.Label();
            this.label2 = new System.Windows.Forms.Label();
            this.cmbSize = new System.Windows.Forms.ComboBox();
            this.label1 = new System.Windows.Forms.Label();
            this.ffcFamilyName = new FontFamilyControl();
            this.lblPreview = new System.Windows.Forms.Label();
            this.gpbBackgroundColor = new System.Windows.Forms.GroupBox();
            this.sldBackgroundOpacity = new RampSlider();
            this.cbBackgroundColor = new ColorButton();
            this.chkBackgroundColor = new System.Windows.Forms.CheckBox();
            this.tabAdvanced = new System.Windows.Forms.TabPage();
            this.labelAlignmentControl1 = new LabelAlignmentControl();
            ...
            this.sliderOpacityShadow = new RampSlider();
            this.label6 = new System.Windows.Forms.Label();
            this.colorButtonShadow = new ColorButton();
            this.tabMembers = new System.Windows.Forms.TabPage();
            this.sqlMembers = new SQLQueryControl();
            ...
            this.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Form}");
            // 
            // splitContainer1
            // 
            ...
            // btnCategoryDown
            // 
            this.btnCategoryDown.Image = ResourceService.GetImageResource("Down_16px") as Image;
            ...
            // btnCategoryUp
            // 
            this.btnCategoryUp.Image = ResourceService.GetImageResource("Up_16px") as Image;
            ...
            // btnSubtract
            // 
            this.btnSubtract.Image = ResourceService.GetImageResource("Layer.Remove_16px") as Image;
            ...
            // btnAdd
            // 
            this.btnAdd.Image = ResourceService.GetImageResource("Layer.Add_16px") as Image; 
            ...
            this.lblSymbolGroups.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.lblSymbolGroups}");
            // 
            // tabs
            // 
            ...
            this.tabExpression.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.tabExpression}");
            ...
            this.tabBasic.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.tabBasic}");
            // 
            // tbFloatingFormat
            // 
            ...
            this.label13.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label13}");
            // 
            // grbLabelRotation
            // 
            ...
            this.grbLabelRotation.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.grbLabelRotation}");
            // 
            // rbLineBasedAngle
            // 
            ...
            this.rbLineBasedAngle.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.rbLineBasedAngle}");
            ...
            this.ttLabelSetup.SetToolTip(this.cmbLabelAngleField, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.cmbLabelAngleField.Tooltip}"));
            ...
            this.ttLabelSetup.SetToolTip(this.rbIndividualAngle, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.rbIndividualAngle.Tooltip}"));
            this.rbIndividualAngle.UseVisualStyleBackColor = true;
            this.rbIndividualAngle.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.rbIndividualAngle}");
            ...
            this.ttLabelSetup.SetToolTip(this.rbCommonAngle, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.rbCommonAngle.Tooltip}"));
            this.rbCommonAngle.UseVisualStyleBackColor = true;
            this.rbCommonAngle.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.rbCommonAngle}");
            ...
            this.ttLabelSetup.SetToolTip(this.nudAngle, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.nudAngle.Tooltip}"));
            ...
            this.ttLabelSetup.SetToolTip(this.chkPrioritizeLow, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkPrioritizeLow.Tooltip}"));
            this.chkPrioritizeLow.UseVisualStyleBackColor = true;
            this.chkPrioritizeLow.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkPrioritizeLow}");
            ...
            this.ttLabelSetup.SetToolTip(this.chkPreventCollision, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkPreventCollision.Tooltip}"));
            this.chkPreventCollision.UseVisualStyleBackColor = true;
            this.chkPreventCollision.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkPreventCollision}");
            ...
            this.lblPriorityField.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.lblPriorityField}");
            // 
            // cmbPriorityField
            // 
            ...
            this.ttLabelSetup.SetToolTip(this.cmbPriorityField, ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.cmbPriorityField.Tooltip}"));
            ...
            this.chkBorder.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkBorder}");
            ...
            this.sldBorderOpacity.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.sldBorderOpacity}");
            // 
            // cbBorderColor
            // 
            ...
            this.gpbFont.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.gpbFont}");
            // 
            // lblFontColor
            // 
            resources.ApplyResources(this.lblFontColor, "lblFontColor");
            this.lblFontColor.Name = "lblFontColor";
            this.lblFontColor.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.lblFontColor}");
            // 
            // sldFontOpacity
            // 
            ...
            this.sldFontOpacity.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.sldFontOpacity}");
            // 
            // cbFontColor
            // 
            ...
            this.lblFamily.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.lblFamily}");
            // 
            // label2
            // 
            resources.ApplyResources(this.label2, "label2");
            this.label2.Name = "label2";
            this.label2.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label2}");
            // 
            // cmbSize
            // 
            ...
            this.label1.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label1}");
            // 
            // ffcFamilyName
            // 
            ...
            this.lblPreview.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.lblPreview}");
            // 
            // gpbBackgroundColor
            // 
            ...
            this.sldBackgroundOpacity.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.sldBackgroundOpacity}");
            // 
            // cbBackgroundColor
            // 
            ...
            this.chkBackgroundColor.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkBackgroundColor}");
            ...
            this.tabAdvanced.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.tabAdvanced}");
            // 
            ...
            this.grpOffset.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.grpOffset}");
            // 
            // nudYOffset
            // 
            ...
            this.label10.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label10}");
            // 
            // chkHalo
            // 
            ...
            this.chkHalo.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.chkHalo}");
            ...
            this.label5.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label5}");
            // 
            // label4
            // 
            resources.ApplyResources(this.label4, "label4");
            this.label4.Name = "label4";
            this.label4.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label4}");
            // 
            // label3
            // 
            resources.ApplyResources(this.label3, "label3");
            this.label3.Name = "label3";
            this.label3.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label3}");
            // 
            // cmbAlignment
            // 
            ...
            ICSharpCode.Core.StringParser.Parse("${res:UI.Alignment.Left}"),
            ICSharpCode.Core.StringParser.Parse("${res:UI.Alignment.Center}"),
            ICSharpCode.Core.StringParser.Parse("${res:UI.Alignment.Right}")});
            ...
            this.label7.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label7}");
            // 
            // nudShadowOffsetX
            // 
            ...
            this.sliderOpacityShadow.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.sliderOpacityShadow}");
            // 
            // label6
            // 
            resources.ApplyResources(this.label6, "label6");
            this.label6.Name = "label6";
            this.label6.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.Label6}");
            // 
            // colorButtonShadow
            // 
            ...
            this.tabMembers.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.tabMembers}");
            // 
            // sqlMembers
            // 
            ...
            this.cmdOK.Text = ICSharpCode.Core.StringParser.Parse("${res:UI.OK}");
            ...
            this.cmdCancel.Text = ICSharpCode.Core.StringParser.Parse("${res:UI.Cancel}");
            ...
            this.cmdApply.Text = ICSharpCode.Core.StringParser.Parse("${res:UI.Apply}");
            ...
            this.lblHelp.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Label.lblHelp}");
            // 
            // panel1
            // 
