...
namespace GIS.Common.Dialogs
{
    partial class DetailedLineSymbolControl
    {
        ...
        private string _checkBoxSmoothingText = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.CheckBoxSmoothing}");
        private string _strokeTypeSimple = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.StrokeType.Simple}");
        private string _strokeTypeCartographic = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.StrokeType.Cartographic}");
        private string _symbolizerCharacteristic = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.SymbolizerCharacteristic}");
        private string _preview = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Preview}");
        private string _scaleMode = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.ScalMode}");
        private string _scaleModeSimple = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.ScalMode.Simple}");
        private string _scaleModeSymbolic = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.ScalMode.Symbolic}");
        private string _scaleModeGeographic = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.ScalMode.Geographic}");
        private string _strokeType = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.StrokeType}");
        private string _simpleLine = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.SimpleLine}");
        private string _opacity = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Opacity}");
        private string _color = StringParser.Parse("${res:GIS.Common.Dialogs.Color}");
        private string _strokeStyleSolid = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.strokeStyle.Solid}");
        private string _strokeStyleDash = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.strokeStyle.Dash}");
        private string _strokeStyleDot = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.strokeStyle.Dot}");
        private string _strokeStyleDashDot = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.strokeStyle.DashDot}");
        private string _strokeStyleDashDotDot = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.strokeStyle.DashDotDot}");
        private string _strokeStyleCustom = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.strokeStyle.Custom}");
        private string _dashStyle = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.DashStyle}");
        private string _width = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Width}");
        private string _cartographicLine = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.CartographicLine}");
        private string _lineCaps = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.LineCaps}");
        private string _startCaps = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.StratCaps}");
        private string _endCaps = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.EndCaps}");
        private string _offset = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Offset}");
        private string _lineJoins = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.LineJoins}");
        private string _tabDash = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.TabDash}");
        private string _pecentualPosition = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.PecentualPosition}");
        private string _btnEdit = StringParser.Parse("${res:UI.Edit}");
        private string _symbol = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Symbol}");
        private string _numberOfPosition = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.NumberOfPosition}");
        private string _rotation = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Rotation}");
        private string _rotationFix = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.RotationFix}");
        private string _rotationWithLine = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.RotationWithLine}");
        private string _flip = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Flip}");
        private string _flipFirst = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Flip.FlipFirst}");
        private string _flipAll = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.Flip.FlipAll}");
        private string _rampText = StringParser.Parse("${res:GIS.Common.Dialogs.Symbol.RampText}");
        ...
        private void InitializeComponent()
        {
            ...
            this.cbColorSimple = new ColorButton();
            this.sldOpacitySimple = new RampSlider();
            this.cmbStrokeStyle = new System.Windows.Forms.ComboBox();
            this.label2 = new System.Windows.Forms.Label();
            this.dblWidth = new DoubleBox();
            ...
            this.cbColorCartographic = new ColorButton();
            this.sldOpacityCartographic = new RampSlider();
            this.dblStrokeOffset = new DoubleBox();
            this.radLineJoin = new LineJoinControl();
            this.dblWidthCartographic = new DoubleBox();
            this.tabDash = new System.Windows.Forms.TabPage();
            this.dashControl1 = new DashControl();
            ...
            this.dblOffset = new DoubleBox();
            this.ccDecorations = new DecorationCollectionControl();
            this.ttHelp = new System.Windows.Forms.ToolTip(this.components);
            this.ccStrokes = new StrokeCollectionControl();
            ...
            this.chkSmoothing.Text = _checkBoxSmoothingText;
            ...
            this.groupBox1.Text = _symbolizerCharacteristic;
            ...
            this.lblScaleMode.Text = _scaleMode;
            ...
            this.tabSimple.Text = _simpleLine;
            ...
            this.sldOpacitySimple.RampText = _rampText;
    ...
    "ating point value.";
            ...
            this.tabCartographic.Text = _cartographicLine;
            ...
            this.lblColorCartographic.Text = _color;
            ...
            this.lblOpacityCartographic.Text = _opacity;
            ...
            this.lblStartCap.Text = _startCaps;
            ...
            this.dblStrokeOffset.Text = _offset;
    ...
    "ating point value.";
            ...
            this.radLineJoin.Text = _lineJoins;
            ...
            this.dblWidthCartographic.Text = _width;
    ...
    "ating point value.";
            ...
            this.lblPercentualPosition.Text = _pecentualPosition;
            ...
            this.lblNumberOfPositions.Text = _numberOfPosition;
            ...
            this.grpRotation.Text = _rotation;
            ...
            this.radRotationFixed.Text = _rotationFix;
            ...
            this.radRotationWithLine.Text = _rotationWithLine;
            ...
            this.chkFlipFirst.Text = _flipFirst;
