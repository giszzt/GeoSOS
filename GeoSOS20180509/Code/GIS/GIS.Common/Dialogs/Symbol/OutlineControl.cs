...
namespace GIS.Common.Dialogs
{
    ...
    public class OutlineControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpOutline.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.grpOutline}");
            ...
            this.btnEditOutline.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.btnEditOutline}");
            ...
            this.cbOutlineColor.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.cbOutlineColor}");
            ...
            this.sldOutlineOpacity.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.sldOutlineOpacity}");
            //
            // label2
            //
            ...
            this.label2.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.label2}");
            //
            // dbxOutlineWidth
            //
            ...
            this.dbxOutlineWidth.Caption = ICSharpCode.Core.StringParser.Parse("res:GIS.Common.Dialogs.OutlineControl.dbxOutlineWidth");
            ...
            //this.dbxOutlineWidth.InvalidHelp = "The value entered could not be correctly parsed into a valid double precision flo" +
                                               //"ating point value.";
            this.dbxOutlineWidth.InvalidHelp = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.dbxOutlineWidth.InvalidHelp}");
            ...
            this.chkUseOutline.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.OutlineControl.chkUseOutline}");
