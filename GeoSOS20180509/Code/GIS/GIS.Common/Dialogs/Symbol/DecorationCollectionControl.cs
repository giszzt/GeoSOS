...
namespace GIS.Common.Dialogs
{
    ...
    internal class DecorationCollectionControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            //int buttonWidth = 25;
            //int locationX = btnDown.Location.X;
            //
            // lbxItems
            //
            resources.ApplyResources(this.lbxItems, "lbxItems");
            //lbxItems.Location = new Point(0, 0);
            //lbxItems.Size = new Size(108, 237);
            //lbxItems.Dock = DockStyle.Fill;
            ...
            //panel1.Size = new Size(108, 27);
            //panel1.Dock = DockStyle.Bottom;
            this.panel1.Name = "panel1";
            //
            // btnDown
            //
            //this.btnDown.Image = SymbologyFormsImages.down;
            resources.ApplyResources(this.btnDown, "btnDown");
            this.btnDown.Image = ResourceService.GetImageResource("Down_16px") as Image;
            this.btnDown.Name = "btnDown";
            this.btnDown.UseVisualStyleBackColor = true;
            this.btnDown.Click += new System.EventHandler(this.btnDown_Click);
            //this.btnDown.Width = buttonWidth;
            //
            // btnUp
            //
            //this.btnUp.Image = SymbologyFormsImages.up;
            resources.ApplyResources(this.btnUp, "btnUp");
            this.btnUp.Image = ResourceService.GetImageResource("Up_16px") as Image;
            this.btnUp.Name = "btnUp";
            this.btnUp.UseVisualStyleBackColor = true;
            this.btnUp.Click += new System.EventHandler(this.btnUp_Click);
            //this.btnUp.Width = buttonWidth;
            //this.btnUp.Location = new Point(locationX + buttonWidth, 0);
            //
            // btnRemove
            //
            //this.btnRemove.Image = SymbologyFormsImages.mnuLayerClear;
            resources.ApplyResources(this.btnRemove, "btnRemove");
            this.btnRemove.Image = ResourceService.GetImageResource("Delete_16px") as Image;
            this.btnRemove.Name = "btnRemove";
            this.btnRemove.UseVisualStyleBackColor = true;
            this.btnRemove.Click += new System.EventHandler(this.btnRemove_Click);
            //this.btnRemove.Width = buttonWidth;
            //this.btnRemove.Location = new Point(locationX + buttonWidth * 2, this.btnDown.Location.Y);
            //
            // btnAdd
            //
            //this.btnAdd.Image = SymbologyFormsImages.mnuLayerAdd;
            resources.ApplyResources(this.btnAdd, "btnAdd");
            this.btnAdd.Image = ResourceService.GetImageResource("Add_16px") as Image;
            this.btnAdd.Name = "btnAdd";
            this.btnAdd.UseVisualStyleBackColor = true;
            this.btnAdd.Click += new System.EventHandler(this.btnAdd_Click);
            //this.btnAdd.Width = buttonWidth;
            //this.btnAdd.Location = new Point(locationX + buttonWidth * 3, this.btnDown.Location.Y);
            //
