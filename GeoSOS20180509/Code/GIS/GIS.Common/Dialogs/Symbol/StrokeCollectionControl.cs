...
namespace GIS.Common.Dialogs
{
    ...
    internal class StrokeCollectionControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _lbxItems.Size = new Size (120,450);
            //_lbxItems.Dock = DockStyle.Fill;
            //
            // _panel1
            //
            ...
            _panel1.Size = new Size(400, 400);
            _panel1.Location = new Point(0, 450);
            ...
            this._btnDown.Image = ResourceService.GetImageResource("Down_16px") as Image;
            ...
            this._btnUp.Image = ResourceService.GetImageResource("Up_16px") as Image;
            ...
            this._btnRemove.Image = ResourceService.GetImageResource("Delete_16px") as Image;
            ...
            this._btnAdd.Image = ResourceService.GetImageResource("Add_16px") as Image;
