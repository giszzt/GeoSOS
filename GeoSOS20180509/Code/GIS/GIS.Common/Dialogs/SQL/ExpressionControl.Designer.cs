...
namespace GIS.Common.Dialogs
{
    partial class ExpressionControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblFields.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.Expression.lblFields}");
            // 
            // lblSelectPrecursor
            // 
            resources.ApplyResources(this.lblSelectPrecursor, "lblSelectPrecursor");
            this.lblSelectPrecursor.Name = "lblSelectPrecursor";
            this.lblSelectPrecursor.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.lblSelectPrecursor}");
            // 
            // rtbExpression
            // 
            ...
            this.groupBox1.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.groupBox1}");
            ...
            this.groupBox2.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.groupBox2}");
            ...
            this.btValidate.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.btValidate}");
            // 
            // btNewLine
            // 
            ...
            this.btNewLine.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.btNewLine}");
            ...
            this.label14.Text = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.label14}");
            // 
            // dgvFields
            // 
            ...
            this.dgvcName.HeaderText = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.dgvcName}");
            // 
            // dgvcType
            // 
            ...
            this.dgvcType.HeaderText = ICSharpCode.Core.StringParser.Parse("${res:GIS.Common.Dialogs.ExpressionControl.dgvcType}");
            // 
            // ExpressionControl
            // 
