...
namespace FrameWork.Gui
{
	public interface IStatusBarService
	{
        ...
        void SetCaretPosition(double x, double y, double z);
	...
	sealed class FwStatusBarService : IStatusBarService
	{
		readonly FwStatusBar statusBar;
		
		public FwStatusBarService(FwStatusBar statusBar)
		{
			if (statusBar == null)
        ...
        public void SetCaretPosition(double x, double y, double z)
		{
			statusBar.CursorStatusBarPanel.Content = StringParser.Parse(
				"${res:StatusBarService.CursorStatusBarPanelText}",
                new StringTagPair("X", String.Format("{0,-30}", x)),
                new StringTagPair("Y", String.Format("{0,-30}", y)),
                new StringTagPair("Z", String.Format("{0,-30}", z)));
		}
