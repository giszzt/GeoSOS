...
namespace FrameWork
{
	public static class FileService
	{
		...
		public static void Unload()
		{
            ...
            //ParserService.LoadSolutionProjectsThreadEnded -= ParserServiceLoadSolutionProjectsThreadEnded;//by hanz
		...
		public static IViewContent JumpToFilePosition(string fileName, int line, int column)
		{
            ...
            //NavigationService.SuspendLogging();//by hanz
			...
			try {
				...
				if (content is IPositionable) {
                    ...
                    //NavigationService.ResumeLogging();//by hanz
					loggingResumed = true;
					((IPositionable)content).JumpTo(Math.Max(1, line), Math.Max(1, column));
				} else {
                    //NavigationService.ResumeLogging();//by hanz
					loggingResumed = true;
                    //NavigationService.Log(content);//by hanz
				}
