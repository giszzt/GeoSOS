...
namespace FrameWork
{
	public class ContextMenuCommand : MenuItem, IStatusUpdate
	{       
		object caller;
		Codon codon;
		...
		public ContextMenuCommand(Codon codon, object caller, IEnumerable<ICondition> conditions)
		...
		public ContextMenuCommand(Codon codon, object caller, bool createCommand, IEnumerable<ICondition> conditions)
		{
		...
		public ContextMenuCommand(string label, EventHandler handler) : this(label)
		{
			this.Click  += handler;
		}
		
		public ContextMenuCommand(string label)
		{
            //this.RightToLeft = RightToLeft.Inherit;
			this.codon  = null;
			this.caller = null;
