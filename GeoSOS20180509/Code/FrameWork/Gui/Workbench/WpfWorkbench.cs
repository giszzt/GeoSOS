...
namespace FrameWork.Gui
{
    ...
    {
        const string mainMenuPath = "/FrameWork/MainMenu";
        const string ribbonPath = "/FrameWork/Ribbon";
        const string padsPath = "/FrameWork/Pads";
        const string toolStripPath = "/FrameWork/ToolStrips";
        const string toolBarPath = "/FrameWork/ToolBars";
        ...
        FwStatusBar statusBar = new FwStatusBar();
        System.Windows.Controls.ToolBar[] toolBars;
        System.Windows.Forms.ToolStrip[] toolStrips;

        public WpfWorkbench()
        {
            this.SynchronizingObject = new WpfSynchronizeInvoke(this.Dispatcher);
            this.StatusBar = new FwStatusBarService(statusBar);
            InitializeComponent();
        ...
        void OnRequestNavigate(object sender, RequestNavigateEventArgs e)
        {
            ...
            {
                //FileService.OpenFile(e.Uri.ToString());//by hanz
            }
        }
        ...
        void UpdateFlowDirection()
        {
            ...
            ICSharpCode.Core.WinForms.RightToLeftConverter.IsRightToLeft = language.IsRightToLeft;
            this.FlowDirection = language.IsRightToLeft ? FlowDirection.RightToLeft : FlowDirection.LeftToRight;
            //App.Current.Resources[GlobalStyles.FlowDirectionKey] = this.FlowDirection;//by hanz
        }
